...
data class TodayAttendanceApiResponse(
    ...
    @SerializedName("data") val data: List<TeacherAttendance> = emptyList()
) {
    // Convert to TodayAttendanceResponse
    fun toResponse(): TodayAttendanceResponse {
...
data class AttendanceStatisticsResponse(
    ...
    @SerializedName("message") val message: String,
    @SerializedName("data") val data: AttendanceStatistics?
)
