...
class TeacherResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema
            ->schema([
                \Filament\Schemas\Components\Section::make('Teacher Information')
                ...
                \Filament\Schemas\Components\Section::make('Hari Kerja')
                    ->description('Pilih hari-hari kerja guru (leave empty untuk semua hari)')
                    ->schema([
