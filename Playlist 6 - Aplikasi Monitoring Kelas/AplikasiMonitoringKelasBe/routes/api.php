...
use App\Http\Controllers\GuruPenggantiConfirmationController;
...
Route::middleware(['auth:sanctum', 'role:siswa'])->group(function () {
    ...
    Route::post('/guru-pengganti/confirm', [GuruPenggantiConfirmationController::class, 'confirm']);
});

// Guru Pengganti list - accessible by authenticated users
Route::middleware(['auth:sanctum'])->get('/guru-pengganti', [GuruPenggantiController::class, 'index']);
...
Route::middleware(['auth:sanctum', 'role:kurikulum,guru'])->group(function () {
    ...
    // Guru Pengganti Confirmation Report
    Route::get('/guru-pengganti/confirmation/report', [GuruPenggantiConfirmationController::class, 'getReport']);
    Route::get('/guru-pengganti/{id}/confirmations', [GuruPenggantiConfirmationController::class, 'getConfirmationsByGuruPengganti']);
});
