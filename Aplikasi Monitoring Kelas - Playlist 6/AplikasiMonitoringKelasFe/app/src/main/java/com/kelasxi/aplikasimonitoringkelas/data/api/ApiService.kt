...
interface ApiService {
    ...
    suspend fun getTodayAttendance(
        @Header("Authorization") token: String
    ): Response<TodayAttendanceApiResponse>
    ...
    // ==================== SISWA: Guru Pengganti Confirmation ====================
    
    @POST("guru-pengganti/confirm")
    suspend fun confirmReplacementTeacher(
        @Header("Authorization") token: String,
        @Body request: ConfirmReplacementTeacherRequest
    ): Response<ApiResponse<ReplacementConfirmation>>
    
    // ==================== KURIKULUM: Guru Pengganti Confirmation Report ====================
    
    @GET("guru-pengganti/confirmation/report")
    suspend fun getReplacementTeacherReport(
        @Header("Authorization") token: String,
        @Query("tanggal") tanggal: String? = null,
        @Query("kelas") kelas: String? = null,
        @Query("search") search: String? = null
    ): Response<ReplacementTeacherReportResponse>
    
    @GET("guru-pengganti/{id}/confirmations")
    suspend fun getGuruPenggantiConfirmations(
        @Header("Authorization") token: String,
        @Path("id") id: Int
    ): Response<SpecificGuruPenggantiConfirmationResponse>
}
